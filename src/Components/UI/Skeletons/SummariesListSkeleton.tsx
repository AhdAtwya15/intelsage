                ...
                <table className="min-w-full border-collapse">
                    ...
                    <tbody>
                        ...
                        {rows.map((_, index) => (
                            ...
                            >
                                <td className="pl-5 py-5 text-left rounded-l-2xl">
                                ...
                                <td className="pr-14 py-5 text-right rounded-r-2xl">
...
export default SummariesListSkeleton;